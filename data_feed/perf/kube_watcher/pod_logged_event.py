...
class PodLoggedEvent:
    # parsed event class
    def __init__(self, type, pod_name, container_name, data, cluster_time, local_time):
        self.type = type
    ...
    def __str__(self):
        return f'{self.local_time}, {self.pod_name}, {self.type}, {self.container_name}, {self.data}, {self.cluster_time}'
