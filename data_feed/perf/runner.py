...
from perf.utils import save_stats
...
class Runner:
    def __init__(self):
        ...
        self.scheduler = Scheduler(self.kube_api, self.scheduling_state, self.estimation_state, self.kube_watcher_state)
    ...
    def cleanup(self):
        ...
        save_stats(self.estimation_state.stats)
...
# r.kube_watcher.start([CHANNEL_NODE_KUBE_EVENTS, CHANNEL_NODE_OBJECT_EVENTS])
...
# print(r.kube_api.get_or_create_priority_class(0))
# time.sleep(900)
# r.kube_watcher.stop()
