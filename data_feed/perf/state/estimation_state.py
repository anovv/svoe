...
class PodEstimationResultEvent(PodLoggedEvent):
    ...
    INTERRUPTED_DF_CONTAINER_HEALTH_LIVENESS = 'PodEstimationResultEvent.INTERRUPTED_DF_CONTAINER_HEALTH_LIVENESS'
    INTERRUPTED_DF_CONTAINER_HEALTH_STARTUP = 'PodEstimationResultEvent.INTERRUPTED_DF_CONTAINER_HEALTH_STARTUP'
