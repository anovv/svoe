...
from svoe.featurizer.data_definitions.common.trades.cryptotick.cryptotick_trades import CryptotickTradesData
from svoe.featurizer.data_definitions.common.trades.cryptotick.utils import preprocess_trades_df
from svoe.featurizer.sql.db_actor import DbActor
from svoe.featurizer.data_ingest.models import InputItem
...
from svoe.common.pandas import df_utils
...
from svoe.featurizer.storage.data_store_adapter.remote_data_store_adapter import RemoteDataStoreAdapter
...
def load_split_catalog_store_df(
    ...
    if data_source_definition == CryptotickL2BookIncrementalData.__name__:
        ...
        gen = df_utils.gen_split_df_by_mem(processed_df, chunk_size_kb, split_callback)
    else:
