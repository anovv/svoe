...
import builder as B
from svoe.common.const import Fields
from svoe.featurizer.actors.cache_actor import create_cache_actor
from svoe.featurizer.streaming.feature_stream_graph import FeatureStreamGraph
from svoe.featurizer.batch.task_graph.executor import execute_graph
from svoe.featurizer.batch.task_graph.tasks import merge_blocks
...
from svoe.featurizer.features.definitions.tvi.trade_volume_imb_fd.trade_volume_imb_fd import TradeVolumeImbFD
...
from svoe.featurizer.features.feature_tree.feature_tree import construct_feature, Feature

import unittest
import pandas as pd
from typing import List
from svoe.featurizer.featurizer_utils.testing_utils import mock_feature, mock_ts_df_remote
from svoe.common.pandas.df_utils import concat, plot_multi
from svoe.common.s3.s3_utils import load_df_s3
from svoe.featurizer.blocks.blocks import merge_asof_multi
...
class TestFeaturizerTaskGraph(unittest.TestCase):
    ...
    def test_cryptotick_l2_snap_feature_online(self):
        ...
        online_res = svoe.common.streamz.stream_utils.run_named_events_stream(merged_events, sources, stream)
        print(online_res)
