...
from svoe.cli.featurizer_cli import featurizer_app, FEATURIZER_CLI_NAME
from svoe.cli.trainer_cli import trainer_app, TRAINER_CLI_NAME
from svoe.cli.backtester_cli import backtester_app, BACKTESTER_CLI_NAME
