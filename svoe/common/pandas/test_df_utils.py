...
from svoe.common.pandas.df_utils import get_cached_df
from svoe.common.s3.s3_utils import store_df_s3, load_df_s3
...
class TestDfUtils(unittest.TestCase):
    ...
    def test_store_df(self):
        ...
        print(store_df_s3(path, big_df))
        loaded = load_df_s3(path, use_cache=False)
