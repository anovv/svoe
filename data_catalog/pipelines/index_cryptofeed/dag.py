...
from data_catalog.common.tasks.tasks import filter_existing, load_df, index_df, gather_and_wait, \
    gather_and_wait_empty_return, write_batch, chain_no_ret
...
class IndexCryptofeedDag(Dag):
    ...
    def get(self, workflow_id: str, input_batch: InputItemBatch, stats: Stats, db_actor: DbActor):
        ...
        # TODO figure out how to bind it to the start of the dag
